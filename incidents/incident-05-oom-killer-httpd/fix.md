...
The immediate goal was to restore service with the smallest safe change and then validate the user-visible path. The fix chosen was to reduce worker concurrency, tune application memory, and add monitoring for RSS growth.

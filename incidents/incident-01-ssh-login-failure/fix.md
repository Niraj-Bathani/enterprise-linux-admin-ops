...
The immediate goal was to restore service with the smallest safe change and then validate the user-visible path. The fix chosen was to restore ownership and mode on /home/admin and validate sshd configuration.
...
journalctl -u sshd -b --no-pager | tail -30

...
To prevent recurrence, add a pre-change and post-change checklist for `NetworkManager`. The checklist should include configuration syntax validation, service restart or reload behavior, log review, firewall and SELinux checks where applicable, and one client-side functional test.

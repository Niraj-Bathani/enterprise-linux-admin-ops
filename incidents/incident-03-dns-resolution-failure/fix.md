...
The immediate goal was to restore service with the smallest safe change and then validate the user-visible path. The fix chosen was to restore internal DNS servers in the active NetworkManager profile.
...
systemctl restart NetworkManager || systemctl reload NetworkManager

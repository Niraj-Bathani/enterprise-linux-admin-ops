...
The team needed clearer validation steps for `nginx`. A process being active was not enough evidence that users could complete their workflow. The runbook should show exact commands, expected output, and common log patterns.

## Follow Up Tasks

- Update the runbook with the log pattern: `nginx: [emerg] bind() to 0.0.0.0:80 failed (98: Address already in use)`.

...
The immediate goal was to restore service with the smallest safe change and then validate the user-visible path. The fix chosen was to stop the conflicting service and reserve ownership of port 80 in service documentation.
